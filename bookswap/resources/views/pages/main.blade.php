...
@section('content')
    <div class="container">
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item"><p><a href={{ url('books/creat')}}>Dodaj swoje książki!</a></p>
                <p>Udostępnij informację na temat książek które nie są Ci już potrzene a jesteś gotów podzielić się nimi ze światem!</p>
            </li>
            <li class="list-group-item"><p><a href={{ url('books/index')}}>Przejrzyj dostępne książki!</a></p>
